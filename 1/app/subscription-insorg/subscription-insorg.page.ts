...
export class SubscriptionInsorgPage implements OnInit {
  ...
  constructor(private http: HttpClient, public storageservice: StorageService, public platform: Platform, private store: InAppPurchase2, private translate: TranslateService) {
